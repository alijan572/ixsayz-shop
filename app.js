(function () {
 ...
 const seed = {
  ...
  function saveProduct(e) {
    ...
    if (index >= 0) {
      product.views = Number(state.products[index].views || 0);
      product.added = Number(state.products[index].added || 0);
      product.bought = Number(state.products[index].bought || 0);
  ...
  if (hasFirebaseConfig) {
    app.innerHTML = `<section class="silent-loader"><span></span></section>`;
    startFirebaseSync();
  } else {
    render();
  }
